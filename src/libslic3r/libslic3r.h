...
#define SLIC3R_APP_FULL_NAME "UPStudio 2024"
#define GCODEVIEWER_APP_NAME "UPStudi G-code Viewer"
#define GCODEVIEWER_APP_KEY  "UPStudiGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("UPStudir G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
