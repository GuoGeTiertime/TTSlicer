...
int CLI::run(int argc, char **argv)
{
    ...
    BOOST_LOG_TRIVIAL(info) << "Current OraSlicer Version "<< Tiertime_VERSION << std::endl;
    ...
    int debug_argc = 7;
    char *debug_argv[] = {
        "E:\work\projects\bambu_release\bamboo_slicer\build_debug\src\Debug\UPStudio-2024.exe",
        "--slice",
        "9",
        //"--load-settings",
    ...
    for (auto const &opt_key : m_actions) {
        if (opt_key == "help") {
            ...
            m_print_config.save_to_json(m_config.opt_string(opt_key), std::string("project_settings"), std::string("project"), std::string(Tiertime_VERSION));
...
{
    boost::nowide::cout
        << SLIC3R_APP_KEY <<"-"<< Tiertime_VERSION << ":"
        << std::endl
        << "Usage: UPStudio-2024 [ OPTIONS ] [ file.3mf/file.stl ... ]" << std::endl
        << std::endl
        << "OPTIONS:" << std::endl;
