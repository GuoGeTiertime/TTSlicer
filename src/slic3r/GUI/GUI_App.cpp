...
public:
    ...
    void Decorate(wxBitmap& bmp)
    {
        ...
        auto bs_version = wxString::Format("Based on OrcaSlicer and BambuStudio and PrusaSlicer").ToStdString();
        ...
        wxBitmap logo_bmp = *bmp_cache.load_svg("splash_logo_Tiertime", logo_size, logo_size);
...
// #else
            // version = _L("") + " " + std::string(Tiertime_VERSION);
// #endif
    ...
    Http::get(version_check_url)
        ...
        .on_complete([&](std::string body, unsigned http_status) {
          ...
          try {
            ...
            Semver current_version = get_version(Tiertime_VERSION, matcher);
...
std::string GUI_App::format_display_version()
{
    ...
    version_display = Tiertime_VERSION;
