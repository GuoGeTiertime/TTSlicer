    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var( APP_IMG_PREFIX "192px.png"), wxBITMAP_TYPE_PNG);
        ...
        wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    std::string icon_path = (boost::format("%1%" APP_TITLE_ICO ) % resources_dir()).str();
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("UPStudio 2024 is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("UPStudio 2024 is based on Orca Slicer"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, "UPStudio2024_about", 250);
    ...
    // version
    {
        ...
        auto version_string = _L("UPStudio 2024 ") + " " + std::string(Tiertime_VERSION);
...
// #endif
    ...
    text_list.push_back(_L("UPStudio 2024 is based on OrcaSlicer, BambuStudio, PrusaSlicer, and SuperSlicer."));
