...
#else // _WIN32
    return wxIcon(Slic3r::var( APP_IMG_PREFIX "128px.png"), wxBITMAP_TYPE_PNG);
#endif // _WIN32
}
...
//    });
    ...
    append_menu_item(m_topbar->GetCalibMenu(), wxID_ANY, _L("Tutorial"), _L("Calibration help"),
        [this](wxCommandEvent&) {
            std::string url = "https://github.com/SoftFever/OrcaSlicer/wiki/Calibration"; //modify later, add by guoge 20231018
            // if (const std::string country_code = wxGetApp().app_config->get_country_code(); country_code == "CN") {
            //     // Use gitee mirror for China users
            //     url = "https://gitee.com/n0isyfox/UPStudio-2024-docs/wikis/%E6%A0%A1%E5%87%86/%E6%89%93%E5%8D%B0%E5%8F%82%E6%95%B0%E6%A0%A1%E5%87%86";
            // }
...
#else
    SetIcon(wxIcon(var( APP_IMG_PREFIX "128px.png"), wxBITMAP_TYPE_PNG));
#endif // _WIN32
